<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataUpdate.aspx.cs" Inherits="Web_sysData_DataUpdate" %>
            ...
            <div class="tableSpaceBorder">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="tableBg2" align="left">
                            <asp:Button ID="Button_Update" CssClass="btn_2k3" runat="server" Text=" 变更 " OnClick="Button_Update_Click" />
