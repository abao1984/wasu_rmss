<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupUpdate.aspx.cs" Inherits="Web_sysGroup_GroupUpdate" %>
            ...
            <div class="tableSpaceBorder">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="tableBg2" style="text-align: left">
                            <asp:TextBox ID="GROUPMS" runat="server" Width="240px" CssClass="textBase" TextMode="MultiLine"
                                Wrap="true" Rows="4"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tableBg1" style="text-align: right; width: 180px; height: 30px">
