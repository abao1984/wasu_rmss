<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GroupInsert.aspx.cs" Inherits="Web_sysGroup_GroupInsert" %>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="tableBg2" style="text-align: left">
                            <cc1:ZLTextBox ID="ZLTextBox_GroupCode" runat="server" InputType="varchars" MaxLength="100"
                                onblurCssName="textBase" onfocusCssName="textBaseFocus" CssClass="textBase" Height="26px"
                                Width="240px"></cc1:ZLTextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator_GroupCode" runat="server"
                                Display="Dynamic" ControlToValidate="ZLTextBox_GroupCode" ErrorMessage="*"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator_GroupCode" runat="server"
                                Display="Dynamic" ValidationExpression="^[A-Za-z0-9]+$" ErrorMessage="数字或字母！"
                                ControlToValidate="ZLTextBox_GroupCode"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="tableBg1" style="text-align: right; width: 180px; height: 30px">
                        ...
                        <td class="tableBg2" style="text-align: left">
                            <cc1:ZLTextBox ID="ZLTextBox_GroupName" runat="server" InputType="varchars" onblurCssName="textBase"
                                onfocusCssName="textBaseFocus" CssClass="textBase" MaxLength="200" Height="26px"
                                Width="240px"></cc1:ZLTextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator_GroupName" runat="server"
                                Display="Dynamic" ControlToValidate="ZLTextBox_GroupName" ErrorMessage="*"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="tableBg1" style="text-align: right; width: 180px; height: 30px">
                        ...
                        <td class="tableBg2" style="text-align: left">
                            <asp:TextBox ID="GROUPMS" runat="server" Width="240px" CssClass="textBase" TextMode="MultiLine" Wrap="true" Rows="4"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="tableBg1" style="text-align: right; width: 180px; height: 30px">
                    ...
                    <tr>
                        ...
                        <td class="tableBg2" align="left">
                            <asp:Button ID="Button_Insert" CssClass="btn_2k3" runat="server" Text=" 提交 " OnClick="Button_Insert_Click" />
