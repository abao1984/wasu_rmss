...
// Code is generated on: 2014/6/5 17:11:09
//
...
";
        ...
        /// </summary>
        [Column(Storage = "_ID", CanBeNull = false, DbType = "NUMBER(10) NOT NULL", IsDbGenerated = true, IsPrimaryKey = true)]
        [Devart.Data.Linq.Mapping.SequenceGenerator(Sequence = "my_seq")]
        public long ID
        {
            get
            {
    ...
    public partial class ANNOUNCEMENTRECORD : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_ID", CanBeNull = false, DbType = "NUMBER(10) NOT NULL", IsDbGenerated = true, IsPrimaryKey = true)]
        [Devart.Data.Linq.Mapping.SequenceGenerator(Sequence = "my_seq1")]
        public long ID
        {
            get
            {
