...
// Code is generated on: 2014/6/3 15:13:01
//
...
namespace HSYWContext
{
    ...
    public partial class ANNOUNCEMENTRECORD : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnREADFLAGChanging(decimal value);
        ...
        /// </summary>
        [Column(Name = @"READ_FLAG", Storage = "_READFLAG", CanBeNull = false, DbType = "FLOAT(63) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public decimal READFLAG
        {
            get
            {
