<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuLiFangFaTongJi.aspx.cs"
    Inherits="Web_GZCL_GZBB_ChuLiFangFaTongJi" %>
...
<body>
    ...
    <table border="1" height="100%" cellpadding="0" cellspacing="0" align="center" width="100%">
        <tr>
            <td align="center" class="tdBak" width="15%">
                业务主体
            </td>
            <td width="15%">
            ...
            <td class="tdBak" align="right" width="20%">
                <asp:Button ID="BtnExpExcel" runat="server" Text="导出Excel" CssClass="btn_2k3" onclick="BtnExpExcel_Click" 
                     />
        ...
        <tr height="100%">
            <td colspan="7" valign="top">
                <asp:GridView ID="GridView1" runat="server" Width="100%" SkinID="GridView1" AutoGenerateColumns="False"
