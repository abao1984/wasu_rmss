<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LiuDanJiLuQuery.aspx.cs"
    Inherits="Web_GZCL_GZBB_LiuDanJiLuQuery" %>

<%@ Register Src="../FDZ/windowHeader.ascx" TagName="windowHeader" TagPrefix="uc1" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>历史留单记录查询</title>
            ...
            <td height="1">
                <table style="border-collapse: collapse; width: 100%" cellpadding="1" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td class="tdBak">
                            <asp:TextBox ID="txt_GZBH" runat="server" BorderStyle="None" Width="140px"></asp:TextBox>
                        </td>
                        <td align="center" class="tdBak">
                            业务主体
                        </td>
            ...
            <td style="height: 100%" valign="top">
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" SkinID="GridView2" DataKeyNames="ZBGUID"
                        BorderColor="#5B9ED1" BorderWidth="1px" AllowPaging="True" AllowSorting="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="留单属性" DataField="ldsx" SortExpression="ldsx">
                                <ItemStyle Width="4%" HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="留单原因" DataField="LDYY" SortExpression="LDYY">
                                <ItemStyle Width="6%" HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="留单日期" DataField="LDRQ" SortExpression="LDRQ" DataFormatString="{0:yyyy-MM-dd}">
                                <ItemStyle Width="6%" HorizontalAlign="Center" />
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
