<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuZhangLeiXing_YW.aspx.cs" Inherits="Web_GZCL_GZSZ_GuZhangLeiXing_YW" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenNew(ID) {
             ...
             var str = window.showModalDialog("LeiXingEdit_YW.aspx?GUID=" + ID + "&LB=" + zy, "", "dialogWidth:400px;dialogHeight:300px;center:yes;location:no;status:no;");
             //alert(window.event)
                ...
                <table cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse;
                    ...
                    <tr>
                        <td class="tableHead">
                            ...
                            <asp:Button ID="SaveButton" runat="server" CssClass="btn_2k3" Text="新增类型" OnClientClick="OpenNew('')" />
                            <asp:Button ID="BtnDel" runat="server" CssClass="btn_2k3" ForeColor="Red" Text=" 删 除 "
                                OnClick="BtnDel_Click" OnClientClick="return confirm('确认要删除所选数据吗？');" />
            ...
            <td>
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        SkinID="GridView1" DataKeyNames="GUID" AllowPaging="True" 
                        ...
                        <Columns>
                            ...
                            <%--<asp:TemplateField HeaderText="编码">
                                <ItemTemplate>
                                    <a href="javascript:OpenNew('<%# Eval("GUID")%>','lx');" style="text-decoration: underline;">
                                        <%# Eval("CODEID")%></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="12%" />
                            </asp:TemplateField>--%>
                            <asp:BoundField HeaderText="类型名称" DataField="CODENAME">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center" Width="15%" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="类型描述" DataField="MS">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="业务主体" DataField="PARENT_SPECIALTY">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center" Width="15%" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="业务类型/所属层次" DataField="PARENT_NAME">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center" Width="15%" />
                            </asp:BoundField>                            
