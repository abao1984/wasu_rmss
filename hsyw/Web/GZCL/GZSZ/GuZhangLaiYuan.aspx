<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuZhangLaiYuan.aspx.cs" Inherits="Web_GZCL_GZSZ_GuZhangLaiYuan" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenNew(ID, zy) {
            var str = window.showModalDialog("LaiYuanEdit.aspx?GUID=" + ID , "", "dialogWidth:400px;dialogHeight:300px;center:yes;location:no;status:no;");
            //alert(window.event)
                ...
                <table cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse;
                    ...
                    <tr>
                        <td class="tableHead">
                            ...
                            <asp:Button ID="SaveButton" runat="server" CssClass="btn_2k3" Text="新增来源" OnClientClick="OpenNew('')" />
                            <asp:Button ID="BtnDel" runat="server" CssClass="btn_2k3" ForeColor="Red" 
                                Text=" 删 除 " onclick="BtnDel_Click" OnClientClick="return confirm('确认要删除所选故障来源吗？');" />
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="来源名称">
                                <ItemTemplate>
                                    <a href="javascript:OpenNew('<%# Eval("GUID")%>');" style="text-decoration: underline;">
                                        <%# Eval("CODENAME")%></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="20%" />
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="来源描述" DataField="MS">
                                <HeaderStyle />
