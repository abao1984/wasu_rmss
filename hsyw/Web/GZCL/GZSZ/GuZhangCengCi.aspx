<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuZhangCengCi.aspx.cs" Inherits="Web_GZCL_GZSZ_GuZhangCengCi" %>
    ...
    <title></title>
     <script language="javascript" type="text/javascript">
         function OpenNew(ID) {
             ...
             var str = window.showModalDialog("CengCiEdit.aspx?GUID=" + ID + "&LB=" + zy, "", "dialogWidth:400px;dialogHeight:300px;center:yes;location:no;status:no;");
             //alert(window.event)
                ...
                <table cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse;
                    ...
                    <tr>
                        <td class="tableHead">
                            ...
                            <asp:Button ID="SaveButton" runat="server" CssClass="btn_2k3" Text="" OnClientClick="OpenNew('')" />
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                           ...
                           <%-- <asp:TemplateField HeaderText="编码">
                                <ItemTemplate>
                                    <a href="javascript:OpenNew('<%# Eval("GUID")%>','cc');" style="text-decoration: underline;">
                                        <%# Eval("CODEID")%></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="12%" />
                            </asp:TemplateField>--%>
                            <asp:BoundField HeaderText="层次名称" DataField="CODENAME">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center" Width="20%" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="层次描述" DataField="MS">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="业务主体" DataField="PARENT_NAME">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center"  Width="12%" />
                            </asp:BoundField>
