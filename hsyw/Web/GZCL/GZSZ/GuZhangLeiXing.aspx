<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuZhangLeiXing.aspx.cs" Inherits="Web_GZCL_GZSZ_GuZhangLeiXing" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenNew(ID) {
             ...
             var str = window.showModalDialog("LeiXingEdit.aspx?GUID=" + ID + "&LB=" + zy, "", "dialogWidth:400px;dialogHeight:300px;center:yes;location:no;status:no;");
             //alert(window.event)
                ...
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="所属层次" DataField="PARENT_NAME">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center" Width="15%" />
                            </asp:BoundField>                            
