<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeiXingEdit_YW.aspx.cs" Inherits="Web_GZCL_GZSZ_LeiXingEdit_YW" %>
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="PARENT_NAME" runat="server" Width="100%" AutoPostBack="True"  onselectedindexchanged="PARENT_NAME_SelectedIndexChanged">
                        </asp:DropDownList>
                    </ContentTemplate>
                    <Triggers>
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="CengCi" runat="server" Width="100%">
                        </asp:DropDownList>
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="PARENT_NAME" EventName="SelectedIndexChanged" />
                    </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
