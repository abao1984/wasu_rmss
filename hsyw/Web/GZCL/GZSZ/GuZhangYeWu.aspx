<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuZhangYeWu.aspx.cs" Inherits="Web_GZCL_GZSZ_GuZhangYeWu" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function OpenNew(ID, zy) {
            var str = window.showModalDialog("ZhuanYeEdit.aspx?GUID=" + ID + "&LB=" + zy, "", "dialogWidth:400px;dialogHeight:300px;center:yes;location:no;status:no;");
            //alert(window.event)
                ...
                <table cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse;
                    ...
                    <tr>
                        <td class="tableHead">
                            ...
                            <asp:Button ID="SaveButton" runat="server" CssClass="btn_2k3" Text="新增业务主体" OnClientClick="OpenNew('', 'ywzt')" />
                            <asp:Button ID="BtnDel" runat="server" CssClass="btn_2k3" ForeColor="Red" Text=" 删 除 "
                                OnClick="BtnDel_Click" OnClientClick="return confirm('确认要删除所选故障专业吗？');" />
                ...
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="业务主体" DataField="CODENAME">
                                <HeaderStyle />
                                <ItemStyle HorizontalAlign="Center" Width="20%" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="类别描述" DataField="MS">
                                <HeaderStyle />
