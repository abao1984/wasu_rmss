...
public partial class Web_GZCL_GZSZ_GuZhangMeiJu : System.Web.UI.Page
{
    ...
    {
        string sql = "select * from T_FAU_ENUMDATA where ENUM_SORT='" + ENUM_SORT.Text + "' ";
    ...
    protected void SaveButton_Click(object sender, EventArgs e)
    {
        ...
        DataFunction.SaveData(ds, "T_FAU_ENUMDATA");
        BindGridViewEnum();
    }
