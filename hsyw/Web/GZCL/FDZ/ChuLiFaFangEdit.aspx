<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuLiFaFangEdit.aspx.cs" Inherits="Web_GZCL_FDZ_ChuLiFaFangEdit" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0" style="border-collapse: collapse;" border="1"
        ...
        <tr>
            <td width="30%" class="tdBak" align="center">
                <asp:Label ID="Label3" runat="server" Text="业务类别"></asp:Label>
            </td>
            <td>
