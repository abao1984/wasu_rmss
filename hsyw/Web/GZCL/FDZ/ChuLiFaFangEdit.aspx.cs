...
public partial class Web_GZCL_FDZ_ChuLiFaFangEdit : System.Web.UI.Page
{
    ...
    private void BindDrop()
    {
        ...
        string sql = string.Format(@"select CODENAME,GUID from T_FAU_LXSZ where lb='ywlb' and SFQY=1");
