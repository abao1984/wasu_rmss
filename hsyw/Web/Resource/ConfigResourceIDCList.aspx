<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfigResourceIDCList.aspx.cs"
    Inherits="Web_Resource_ConfigResourceIDCList" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function windowOpen(guid) {
            var url = "ConfigResourceIDCEdit.aspx?GUID=" + guid;
                ...
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="gvLogicEquIp" runat="server" SkinID="GridView1" DataKeyNames="GUID,SUBSCRIBER_ID"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="asset_code" HeaderText="资产编号">
                                <HeaderStyle BorderColor="#5B9ED1" BorderWidth="1px"></HeaderStyle>
                                <ItemStyle BorderColor="#5B9ED1" BorderWidth="1px" HorizontalAlign="Center" Width="12%">
                                </ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="dev_stat" HeaderText="设备状态">
                                <HeaderStyle BorderColor="#5B9ED1" BorderWidth="1px"></HeaderStyle>
                                <ItemStyle BorderColor="#5B9ED1" BorderWidth="1px" HorizontalAlign="Center" Width="12%">
                                </ItemStyle>
                            </asp:BoundField>
