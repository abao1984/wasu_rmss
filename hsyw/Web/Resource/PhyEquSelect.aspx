<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PhyEquSelect.aspx.cs" Inherits="Web_Resource_PhyEquSelect" %>
...
//            //UNIT_ID.Text=bfc13d2d-eab8-4784-a96a-b8ffc21b4e88
//            var unitid=document.getElementById("UNIT_ID").value
//            if (unitid == 'bfc13d2d-eab8-4784-a96a-b8ffc21b4e88') {
//                if (RowId != "") {
//                    
//                    return confirm('该端口已占用，是否复用?')  
//                }
            //            }
        }
        function sfqy(names) {
            document.getElementById("SFFY").value = confirm('端口' + names + '已占用，是否复用?');
        }
...
//                window.close();
//                parent.WindowClose();
                parent.document.getElementById(vr1).value = vr2;
                parent.document.getElementById(vr3).value = vr4;
                //alert(vr5);
                if (vr5 != "" && vr5 != undefined) {
                    parent.document.getElementById(vr5).value = vr6;
                }
                //alert(1);
                window.close();
                parent.WindowClose();
...
<body>
    <form id="form1" runat="server">
     <table id="Main_Table" style="width:100%;height:100%;">
        <tr>
            <td class="tableHead">
             <asp:TextBox ID="LJJF_NAME" runat="server" Width="46px"  style="display:none;"></asp:TextBox>
            ...
            <asp:TextBox ID="TXT_ROWID" runat="server" Width="46px"  style="display:none;"></asp:TextBox>
                ...
                <asp:TextBox ID="P_TXT_NAME" runat="server" Width="103px" style="display:none;"></asp:TextBox>
                ...
                <asp:TextBox ID="TXT_CODE" runat="server" Width="103px" style="display:none;"></asp:TextBox>
                 ...
                 <asp:TextBox ID="RES_CODE" runat="server" Width="103px" style="display:none;"></asp:TextBox>
                  ...
                  <asp:TextBox ID="BRANCH_CODE" runat="server" Width="103px" style="display:none;"></asp:TextBox>
                  <asp:TextBox ID="BRANCH" runat="server" Width="103px" style="display:none;"></asp:TextBox>
                     <asp:TextBox ID="ZYSX" runat="server" Width="103px" style="display:none;"></asp:TextBox>
                     <asp:TextBox ID="SFFY" name="SFFY" runat="server" style="display:none;"></asp:TextBox>
                      <asp:TextBox ID="TABLE_NAME" runat="server" Width="103px" style="display:none;"></asp:TextBox>
