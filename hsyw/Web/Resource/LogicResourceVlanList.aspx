<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogicResourceVlanList.aspx.cs"
    Inherits="Web_Resource_LogicResourceVlanList" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OpenSelectSSQY(name, code) {
    ...
    <table style="width: 100%; height: 100%;">
        <tr>
            <td class="tableHead">
                ...
                &nbsp;
                <asp:Button ID="BtnPLCZ" runat="server" Text="批量操作" CssClass="btn_2k3" OnClientClick="windowOpen('','1')" />
                        ...
                        <td style="width: 13%">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <img src="../Images/Small/bb_table.gif" onclick="OpenSelectSSQY('SSQY','SSQY_CODE')" />
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <tr>
            <td style="height: 100%" valign="top">
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="VlanList" runat="server" SkinID="GridView2" DataKeyNames="GUID"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SSJF" HeaderText="所属机房" ItemStyle-BorderColor="#5b9ed1">
