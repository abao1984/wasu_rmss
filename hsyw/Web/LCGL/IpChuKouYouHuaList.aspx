<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IpChuKouYouHuaList.aspx.cs" Inherits="Web_LCGL_IpChuKouYouHuaList" %>
...
<head id="Head1" runat="server">
    ...
    <script  language="javascript" type="text/javascript">
        ...
        function windowOpenEdit(guid) {
            ...
            var url = "IpChuKouYouHuaEdit.aspx?GUID=" + guid + "&JDBM=" + jdbm;
            windowOpenPage(url, "IP地址出口优化申请单", "MenuButton");
        }
    </script>
</head>
<body>
