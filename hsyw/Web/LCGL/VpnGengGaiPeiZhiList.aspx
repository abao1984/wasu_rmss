<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VpnGengGaiPeiZhiList.aspx.cs" Inherits="Web_LCGL_VpnGengGaiPeiZhiList" %>
...
<head runat="server">
    ...
    <script  language="javascript" type="text/javascript">
        ...
        function windowOpenEdit(guid) {
            ...
            var url = "VpnGengGaiPeiZhiEdit.aspx?GUID="+guid+"&JDBM="+jdbm;
            windowOpenPage(url, "VPN更改配置单", "MenuButton");
        }
    </script>
</head>
<body>
