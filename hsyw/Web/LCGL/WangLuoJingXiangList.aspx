<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WangLuoJingXiangList.aspx.cs" Inherits="Web_LCGL_WangLuoJingXiangList" %>
...
<head id="Head1" runat="server">
    ...
    <script  language="javascript" type="text/javascript">
        ...
        function windowOpenEdit(guid) {
            ...
            var url = "WangLuoJingXiangEdit.aspx?GUID=" + guid + "&JDBM=" + jdbm;
            windowOpenPage(url, "网路监控申请单", "MenuButton");
        }
    </script>
</head>
<body>
