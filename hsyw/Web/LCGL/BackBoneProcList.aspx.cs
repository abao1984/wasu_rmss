...
public partial class Web_LCGL_BackBoneProcList : BasePage
{
    ...
    private string last1Jdbm = "YWRQ";
    private string lastJdbm = "GD";
    protected void Page_Load(object sender, EventArgs e)
    {
        TxtLcbm.Text = Request.QueryString["lcbm"];
        lcbm = TxtLcbm.Text;
        CreateMenuTable();
        TxtfirstJdbm.Text = Request.QueryString["firstJdbm"];
        TxtlastJdbm.Text = Request.QueryString["lastJdbm"];
        Txtlast1Jdbm.Text = Request.QueryString["last1Jdbm"];


        firstJdbm = TxtfirstJdbm.Text;
        last1Jdbm = Txtlast1Jdbm.Text;
        lastJdbm = TxtlastJdbm.Text;
