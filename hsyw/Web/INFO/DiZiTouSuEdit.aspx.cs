...
public partial class Web_INFO_DiZiTouSuEdit : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            string sql = "select guid, cxnr, cxjg, yhlx, tslx, hffkxx, gzyy, slrq, hfrq, gzrq, ljcs, bz from t_info_gzts where guid='" + GUID.Text + "'";
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataFunction.SaveData(ds, "T_INFO_GZTS");
