...
public partial class Web_INFO_JianKongSbEdit : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            string sql = "select guid, sbbh, sbmc, jrfs, sbzt, sbdz from t_info_jksb where guid='" + GUID.Text + "'";
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataFunction.SaveData(ds, "T_INFO_JKSB");
