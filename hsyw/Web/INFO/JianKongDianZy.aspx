<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JianKongDianZy.aspx.cs" Inherits="Web_INFO_JianKongDianZy" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function windowOpen(lx, id) {
            var url = "JianKongDianZyEdit.aspx?lx=" + lx + "&id=" + id;
            windowOpenPage(url, "信息维护", "BtnRfh");
        }
        function ExpTemp() {
            window.open("Temp/地址投诉模板.xls");
            return false;
        }
        function btnImport() {
            ...
            <tr>
                <td class="tdBak">
                    ...
                    bordercolor="#5b9ed1" width="100%">
                        <tr>
                            <td width="20%" align="right" class="tdBak">监控点编号</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtJkdBh" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td  width="20%" align="right" class="tdBak">监控点名称</td>
                            <td  width="30%">
                                <asp:TextBox ID="Txtjkdmc" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                         <tr>
                            <td align="right" class="tdBak">监控点地址</td>
                            <td>
                                <asp:TextBox ID="Txtjkddz" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td align="right" class="tdBak">保持时限</td>
                            <td>
                                <asp:TextBox ID="Txtbcsx" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                         <tr>
                            <td align="right" class="tdBak">码流</td>
                            <td>
                                <asp:TextBox ID="Txtml" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                            <td align="right" class="tdBak">所属设备编码</td>
                            <td>
                                <asp:TextBox ID="Txtsbbh" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="监控点编号">
                                <ItemTemplate>
                                    <a href="javascript:windowOpen('Edit','<%# Eval("GUID") %>');" 
                                        style="text-decoration: underline;"><%# Eval("JKDBH") %></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="监控点名称" DataField="JKDMC">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="监控点地址" DataField="JKDDZ">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="保持时限" DataField="BCSX">
                                <HeaderStyle />
                            </asp:BoundField>
                             <asp:BoundField HeaderText="码流" DataField="ML">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="所属设备编码" DataField="SBBH">
                                <HeaderStyle />
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
