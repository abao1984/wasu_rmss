<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JianKongYeWuPz.aspx.cs" Inherits="Web_INFO_JianKongYeWuPz" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function windowOpen(lx, id) {
            var url = "JianKongYeWuPzEdit.aspx?lx=" + lx + "&id=" + id;
            ...
            <tr>
                <td class="tdBak">
                    ...
                    bordercolor="#5b9ed1" width="100%">
                        <tr>
                            <td width="20%" align="right" class="tdBak">业务编号</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtYwBh" Width="100%" runat="server"></asp:TextBox>
                            </td>
                         ...
                         <tr>
                            <td align="right" class="tdBak">客户名称</td>
                            <td>
                ...
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="业务编号">
                                <ItemTemplate>
                                    <a href="javascript:windowOpen('Edit','<%# Eval("GUID") %>');" 
                                        style="text-decoration: underline;"><%# Eval("YWBH") %></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="客户编号" DataField="KHBH">
                                <HeaderStyle />
                            </asp:BoundField>
                            ...
                            <asp:BoundField HeaderText="联系人" DataField="LXR">
                             ...
                             <asp:BoundField HeaderText="业务配置时间" DataField="KTSJ" HtmlEncode=false DataFormatString="{0:yyyy-MM-dd}" >
                                <HeaderStyle />
                            </asp:BoundField>
