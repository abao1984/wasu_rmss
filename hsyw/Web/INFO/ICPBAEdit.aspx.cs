...
public partial class Web_INFO_ICPBAEdit : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            string sql = "select zbdw, zbdwxz, zbdwzj, zbdwszs, zbdwszshi, zbdwszx, sjzgdw, zbdwdz, wzfzrmc, wzfzrdzyj, wzfzrzj, wzfzrdh, wzfzrsj, wzmc, wzsydz, wzjrdw, wzjrfs, fyqfzdd, sfdtip, wzymlb, ipdzlb, spnr, spjg, drrq, bz from t_info_icpba where guid='" + GUID.Text + "'";
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            string sql = "select guid,zbdw, zbdwxz, zbdwzj, zbdwszs, zbdwszshi, zbdwszx, sjzgdw, zbdwdz, wzfzrmc, wzfzrdzyj, wzfzrzj, wzfzrdh, wzfzrsj, wzmc, wzsydz, wzjrdw, wzjrfs, fyqfzdd, sfdtip, wzymlb, ipdzlb, spnr, spjg, drrq, bz from t_info_icpba where guid='" + GUID.Text + "'";
            DataSet ds = DataFunction.FillDataSet(sql);
            if (ds.Tables[0].Rows.Count == 0)
            {
            ...
            DataFunction.SaveData(ds, "T_INFO_ICPBA");
            ShareFunction.FillControlData(Page, ds.Tables[0].Rows[0]);
