<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KeHuZy.aspx.cs" Inherits="Web_INFO_KeHuZy" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function windowOpen(lx, id) {
            var url = "KeHuZyEdit.aspx?lx=" + lx + "&id=" + id;
            ...
            <tr>
                <td class="tdBak">
                    ...
                    bordercolor="#5b9ed1" width="100%">
                        <tr>
                            <td width="20%" align="right" class="tdBak">客户编号</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtKhbh" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td  width="20%" align="right" class="tdBak">客户名称</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtKhMc" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                         <tr>
                            <td align="right" class="tdBak">客户地址</td>
                            <td>
                                <asp:TextBox ID="TxtKhDz" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td align="right" class="tdBak">联系人</td>
                            <td>
                                <asp:TextBox ID="TxtLxr" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                         <tr>
                            <td align="right" class="tdBak">电话</td>
                            <td>
                                <asp:TextBox ID="TxtDh" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                            <td align="right" class="tdBak">备注</td>
                            <td>
                                <asp:TextBox ID="TxtBz" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="客户编号">
                                <ItemTemplate>
                                    <a href="javascript:windowOpen('Edit','<%# Eval("GUID") %>');" 
                                        style="text-decoration: underline;"><%# Eval("KHBH") %></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            ...
                            <asp:BoundField HeaderText="客户地址" DataField="KHDZ">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="联系人" DataField="LXR">
                                <HeaderStyle />
                            </asp:BoundField>
                             <asp:BoundField HeaderText="电话" DataField="DH">
                                <HeaderStyle />
                            </asp:BoundField>
