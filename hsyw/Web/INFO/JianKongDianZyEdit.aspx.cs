...
public partial class Web_INFO_JinKongDianZyEdit : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            string sql = "select guid, jkdbh, jkdmc, jkddz, bcsx, ml, sbbh from t_info_zkdzy where guid='" + GUID.Text + "'";
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataFunction.SaveData(ds, "T_INFO_ZKDZY");
