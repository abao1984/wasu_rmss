...
public partial class Web_INFO_JianKongYeWuPzEdit : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            string sql = "select guid, ywbh, khbh, khmc, ktsj, lxr, dh, khdz, bz from t_info_jkywpz where guid='" + GUID.Text + "'";
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataFunction.SaveData(ds, "T_INFO_JKYWPZ");
