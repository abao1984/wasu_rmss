<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HuLianHuTongZyPz.aspx.cs" Inherits="Web_INFO_HuLianHuTongZyPz" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function windowOpen(lx, id) {
            var url = "HuLianHuTongZyPzEdit.aspx?lx=" + lx + "&id=" + id;
            ...
            <tr>
                <td class="tdBak">
                    ...
                    bordercolor="#5b9ed1" width="100%">
                        <tr>
                            <td width="20%" align="right" class="tdBak">编号</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtBh" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td  width="20%" align="right" class="tdBak">名称</td>
                            <td colspan="2"  width="30%">
                                <asp:TextBox ID="TxtMc" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                         <tr>
                            <td align="right" class="tdBak">本地接入设备</td>
                            <td>
                                <asp:TextBox ID="TxtBDJRSB" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td align="right" class="tdBak">对端单位信息</td>
                            <td colspan="2">
                                <asp:TextBox ID="TxtDDDWXX" Width="100%" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                         <tr>
                            <td align="right" class="tdBak">中间链路商</td>
                            <td>
                                <asp:TextBox ID="TxtZJLLS" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td align="right" class="tdBak">光缆路由信息</td>
                            <td colspan="2">
                                 <asp:TextBox ID="TxtGLLYXX" runat="server" 
                            ...
                            <asp:TemplateField HeaderText="编号">
                                <ItemTemplate>
                                    <a href="javascript:windowOpen('Edit','<%# Eval("GUID") %>');" 
                                        style="text-decoration: underline;"><%# Eval("BH")%></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="名称" DataField="MC">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="本地接入设备" DataField="BDJRSB">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="本地接入端口" DataField="BDJRDK">
                                <HeaderStyle />
                            </asp:BoundField>
                             <asp:BoundField HeaderText="对端单位信息" DataField="DDDWXX">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="中间链路商" DataField="ZJLLS">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="光缆路由信息" DataField="GLLYXX">
                                <HeaderStyle />
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
