<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JianKongSb.aspx.cs" Inherits="Web_INFO_JianKongSb" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function windowOpen(lx, id) {
            var url = "JianKongSbEdit.aspx?lx=" + lx + "&id=" + id;
            ...
            <tr>
                <td class="tdBak">
                    ...
                    bordercolor="#5b9ed1" width="100%">
                        <tr>
                            <td width="20%" align="right" class="tdBak">设备编号</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtSbBh" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td  width="20%" align="right" class="tdBak">设备名称</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtSbmc" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                         <tr>
                            <td align="right" class="tdBak">接入方式</td>
                            <td>
                                <asp:TextBox ID="TxtJRFS" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td align="right" class="tdBak">设备状态</td>
                            <td>
                                <asp:DropDownList ID="ddlSbZt" Width="100%" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                         </table>
                            ...
                            <asp:TemplateField HeaderText="设备编号">
                                <ItemTemplate>
                                    <a href="javascript:windowOpen('Edit','<%# Eval("GUID") %>');" 
                                        style="text-decoration: underline;"><%# Eval("SBBH") %></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="设备名称" DataField="SBMC">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="接入方式/IP" DataField="JRFS">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="设备状态" DataField="SBZT">
                                <HeaderStyle />
                            </asp:BoundField>
                             <asp:BoundField HeaderText="监控设备地址" DataField="SBDZ">
                                <HeaderStyle />
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
