<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IpDiZhiBeiAn.aspx.cs" Inherits="Web_INFO_IpDiZhiBeiAn" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function windowOpen(lx, id) {
            var url = "IpDiZhiBeiAnEdit.aspx?lx=" + lx + "&id=" + id;
            windowOpenPage(url, "信息维护", "BtnRfh");
        }
        function ExpTemp() {
            window.open("../../template/IP地址备案模版.xls");
            return false;
        }
        function btnImport() {
            ...
            <tr>
                <td class="tdBak">
                    ...
                    bordercolor="#5b9ed1" width="100%">
                        <tr>
                            <td width="20%" align="right" class="tdBak">IP起始地址</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtQSIPDZ" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td  width="20%" align="right" class="tdBak">单位名称</td>
                            <td colspan="2"  width="30%">
                                <asp:TextBox ID="TxtDWMC" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                         
                         <tr>
                            <td align="right" class="tdBak">联系人姓名</td>
                            <td>
                                <asp:TextBox ID="TxtLXRMC" Width="100%" runat="server"></asp:TextBox>
                            </td>
                ...
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="起始IP地址">
                                <ItemTemplate>
                                    <a href="javascript:windowOpen('Edit','<%# Eval("GUID") %>');" 
                                        style="text-decoration: underline;"><%# Eval("QSIPDZ")%></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                           
                            <asp:BoundField HeaderText="终止IP地址" DataField="ZZIPDZ">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="单位名称" DataField="DWMC">
                                <HeaderStyle />
                            </asp:BoundField>
                             <asp:BoundField HeaderText="单位详细地址" DataField="DWDZ">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="联系人姓名" DataField="LXRMC">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="联系人电话" DataField="LXRDH">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField DataField="LXRDZYJ" HeaderText="联系人电子邮件" />
                            <asp:BoundField DataField="DRRQ" HeaderText="导入日期" HtmlEncode=false DataFormatString="{0:yyyy-MM-dd}"  />
                        </Columns>
                    </asp:GridView>
                </div>
            </td>
