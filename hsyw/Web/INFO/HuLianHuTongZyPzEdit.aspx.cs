...
public partial class Web_INFO_HuLianHuTongZyPzEdit : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        {
            string sql = "select guid, bh, mc, bdjrsb, bdjrdk, dddwxx, ddlxxx, zjlls, zjllslxfs, gllyxx, bz from t_info_hlhtzypz where guid='" + GUID.Text + "'";
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataFunction.SaveData(ds, "T_INFO_HLHTZYPZ");
            ShareFunction.FillControlData(Page, ds.Tables[0].Rows[0]);
