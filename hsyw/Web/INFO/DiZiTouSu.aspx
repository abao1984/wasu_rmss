<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DiZiTouSu.aspx.cs" Inherits="Web_INFO_DiZiTouSu" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function windowOpen(lx, id) {
            ...
            var url = "DiZiTouSuEdit.aspx?lx=" + lx + "&id=" + id;

            windowOpenPage(url, "信息维护", "BtnRfh");
        }
        function ExpTemp() {

            window.open("../../template/地址投诉模板.xls");
            return false;
        }
        function btnImport() {
            ...
            <tr>
                <td class="tdBak">
                    ...
                    bordercolor="#5b9ed1" width="100%">
                        <tr>
                            <td width="20%" align="right" class="tdBak">查询内容</td>
                            <td  width="30%">
                                <asp:TextBox ID="TxtCxNr" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td  width="20%" align="right" class="tdBak">查询结果</td>
                            <td colspan="2"  width="30%">
                                <asp:TextBox ID="TxtCxJg" Width="100%" runat="server"></asp:TextBox> 
                            </td>
                        </tr>
                         <tr>
                            <td align="right" class="tdBak">累计次数</td>
                            <td>
                                <asp:TextBox ID="TxtLjCs" Width="100%" runat="server"></asp:TextBox>
                            </td>
                            <td align="right" class="tdBak">受理日期</td>
                            <td>
                ...
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="投诉类型">
                                <ItemTemplate>
                                    <a href="javascript:windowOpen('Edit','<%# Eval("GUID") %>');" 
                                        style="text-decoration: underline;"><%# Eval("TSLX") %></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="查询内容" DataField="CXNR">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="查询结果" DataField="CXJG">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="受理日期" DataField="SLRQ" HtmlEncode=false DataFormatString="{0:yyyy-MM-dd}" >
                                <HeaderStyle />
                            </asp:BoundField>
                             <asp:BoundField HeaderText="回访日期" DataField="HFRQ" HtmlEncode=false DataFormatString="{0:yyyy-MM-dd}" >
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="累计次数" DataField="LJCS">
                                <HeaderStyle />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="整改日期" DataField="GZRQ" HtmlEncode=false DataFormatString="{0:yyyy-MM-dd}" >
                                <HeaderStyle />
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
