<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionQuery.aspx.cs" Inherits="Web_QuestionMange_QuestionQuery" %>
    ...
    <table style="width: 100%; height: 100%;" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td class="tableHead" style="height: 1px;">
                ...
                <asp:Button ID="BtnDel" runat="server" class="btn_2k3" Text="导出" 
            ...
            <td valign="top" style="height: 100%;">
                <div style="overflow: auto; height: 100%; width: 100%;">
                    <asp:GridView ID="GVQuestion" runat="server" SkinID="GridView1" DataKeyNames="ID"
                        ...
                        AutoGenerateColumns="False" onrowdatabound="GVQuestion_RowDataBound"
                        >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="是否已评审">
                                <ItemTemplate>
                                    <asp:Image ID="imgPs" runat="server" />
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                        </Columns>
